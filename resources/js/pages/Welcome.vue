    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">OpenAI Demo</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Laravel + Vue.js + Inertia.js — RAG AI Agent &amp; Live Context Switching Chatbot.
                    </p>
                    ...
                    <div class="mb-6 flex flex-col gap-3">
                        <Link
                            href="/rag"
                            class="flex items-center gap-3 rounded-lg border border-[#e3e3e0] dark:border-[#3E3E3A] p-4 hover:border-violet-400 hover:bg-violet-50 dark:hover:bg-violet-950/30 transition-colors"
                        >
                            <span class="text-xl">📄</span>
                            <div>
                                <p class="font-semibold text-sm">Assignment 1 — RAG AI Agent</p>
                                <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">Upload a PDF and ask questions about its contents</p>
                            </div>
                            <span class="ml-auto text-violet-500">→</span>
                        </Link>
                        <Link
                            href="/chat"
                            class="flex items-center gap-3 rounded-lg border border-[#e3e3e0] dark:border-[#3E3E3A] p-4 hover:border-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors"
                        >
                            <span class="text-xl">🔄</span>
                            <div>
                                <p class="font-semibold text-sm">Assignment 2 — Context Switching Chatbot</p>
                                <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">Live context switching with persistent session &amp; tool calls</p>
                            </div>
